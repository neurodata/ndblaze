...
class BlazeRedis:
  ...
  def __init__(self, ds, ch, res):
    ...
    try:
      ...
      startup_nodes = [{"host": REDIS_SERVER, "port": "7000"}]
      self.client = rediscluster.StrictRedisCluster(startup_nodes=startup_nodes, decode_responses=False)
